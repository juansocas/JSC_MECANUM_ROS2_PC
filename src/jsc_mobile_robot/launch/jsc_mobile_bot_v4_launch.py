...
def generate_launch_description():
  ...
  default_model_path = os.path.join(pkg_share, 'models/jsc_mobile_bot_v4.urdf')
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf.yaml') 
  robot_name_in_urdf = 'jsc_mobile_bot'
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/urdf_config_v2.rviz')
  world_file_name ='jsc_mobile_bot_world/telematica_v6.world'
  ...
  start_slam_toolbox_cmd = Node(
    ...
    remappings=[('/scan', '/lidar/scan')]  # Asegúrate de que el tópico /scan coincida con el de tu robot
  )
